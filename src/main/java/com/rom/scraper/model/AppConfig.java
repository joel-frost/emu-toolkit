...
public class AppConfig {
    @Getter private final ObservableList<PlatformConfig> platforms = FXCollections.observableArrayList();
    @Getter @Setter private boolean advancedMode = false;
    @Getter @Setter private boolean wizardShown = false;
    @Getter @Setter private String lastDownloadFolder = "";
    @Getter @Setter private PlatformConfig selectedPlatform = null;
     ...
     */
    public boolean hasConfiguredPlatforms() {
        return platforms.stream().anyMatch(PlatformConfig::isConfigured);
    }
